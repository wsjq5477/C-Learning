...
{    
    ...
    { 
        ...
        sdata = 'e';
        send_data(sdata);
        sdata =  48+(unsigned char)(edge_count/10%10);
        send_data(sdata);
        sdata =  48+(unsigned char)(edge_count%10);  
        send_data(sdata);
        sdata = '\n';
        send_data(sdata);
        ...
        sdata = 'r';
        send_data(sdata);
        sdata =  48+(unsigned char)(right_extent/1000);
        send_data(sdata);
        sdata =  48+(unsigned char)(right_extent/100%10);             //将结果拆分并发送
        send_data(sdata);   
