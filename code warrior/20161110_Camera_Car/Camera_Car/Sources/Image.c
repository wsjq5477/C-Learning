    ...
    {                            
        ...
        {           
            ...
            *************************************************************/
            ...
            /*******模拟量输出,阈值全黑为0x30-0x50,全白为0x80+**************  
                      
            if(image[i][j]<0x50&&image[i][j+1]<0x50)
            {
                sdata = 17;
            }
            else if(image[i][j]>0x50&&image[i][j+1]<0x50)
            {
                sdata = 16;
            }
            else if(image[i][j]<0x50&&image[i][j+1]>0x50)
...
{   
    ...
    if(black_line[25]-black_line[12]>5) //左弯道
    {
        delay(5); 
        PWMDTY67=1520;      
    }      
    else if(black_line[12]-black_line[25]>5) //右弯道
    {
        delay(5);     
        PWMDTY67=1100;
    } 
