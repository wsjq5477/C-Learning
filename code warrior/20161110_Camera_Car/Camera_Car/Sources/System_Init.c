...
void PWM_Init(void)
{
    ...
    PWMDTY67=1370;     //高电平1370us,中间位置
    
    /****************占空比设置(已实验)*********************        
    高电平为1370us时：一定为中间位置;                                1370
    高电平为1100us时：一定为最左边位置(右转);保险起见使用1650        1100
    高电平为1530us时：一定为最右边位置(左转);保险起见使用1900        1530
